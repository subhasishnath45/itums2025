...
<!--                       <div class="footer-map">
          ...
          <div class="appointment-section">
            <a href="<?php echo esc_url( get_page_link( 324 ) ); ?>">Book Appointment</a>
          </div>
          <a id="appointment-mobile" href="<?php echo esc_url( get_page_link( 324 ) ); ?>">
          
          </a>

          <!-- <div data-toggle="modal" data-target="#homeVideo" id="video-modal-btn">
            Portal demo
          </div>
          <div id="video-modal-btn-mobile" data-toggle="modal" data-target="#homeVideo">

          </div> -->
          <div class="modal fade" id="homeVideo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <button type="button" class="btn btn-default" data-dismiss="modal" onclick="stopVideo()">X</button>
                <div class="embed-responsive embed-responsive-16by9" id="gossVideo">
                <?php //$videosrc = get_field( "home_slider_video", 29 ); ?>
                          <?php 
                          //$youtube_video_url = get_field('home_slider_video', false, false); 
                          ?>
                          <!-- <iframe id="videoPlayer" width="560" height="315" src="https://www.youtube.com/embed/MCNqodTq5kg?enablejsapi=1&origin=https://itums.co.in" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" class="embed-responsive-item" allowfullscreen></iframe> -->

                          
                  <!-- <iframe width="560" height="315" src="<?php //echo $videosrc; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" class="embed-responsive-item" allowfullscreen></iframe> -->
                    <!-- <iframe id="videoPlayer" width="560" height="315" src="https://www.youtube.com/embed/MCNqodTq5kg?enablejsapi=1&origin=https://itums.co.in" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" class="embed-responsive-item" allowfullscreen></iframe> -->
                </div>
              </div>
            </div>
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/js/jquery.mousewheel.min.js" type="text/javascript"></script>
          <!-- gallery js ends -->
        <!-- <script type="text/javascript" src="<?php //echo get_template_directory_uri(); ?>/js/jquery.form-validator.min.js"></script> -->
        <script type="text/javascript" src="https://cdn.rawgit.com/PascaleBeier/bootstrap-validate/v2.2.0/dist/bootstrap-validate.js"></script>
        <script src="<?php echo get_template_directory_uri(); ?>/js/main.js" type="text/javascript"></script>

        <script type="text/javascript">
              var stopVideo = function ( ) {
              var element = document.getElementById("gossVideo"); 

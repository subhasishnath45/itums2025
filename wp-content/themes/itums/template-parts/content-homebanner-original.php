                        ...
                        <div class="slider-item">
                          <figure>
                            ...
                            <figcaption>
                              ...
                              <?php if(get_field('home_slider_video')){?>
                              <div class="slide-video-wrapper">
                                <div class="slide-video">
                                  <!-- <iframe width="" height="" src="https://www.youtube.com/embed/MCNqodTq5kg?autoplay=0&loop=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                                  <?php 
                                    $iframe = get_field('home_slider_video'); 

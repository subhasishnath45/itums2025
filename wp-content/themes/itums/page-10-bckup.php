                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <ul class="about-list">
                                        <li>
                                          <?php the_field('our_mission_field', $post->ID); ?>
                                        </li>
                                        <li>
                                          <?php the_field('our_vision_field', $post->ID); ?>
                                      </li>
                                        <li>
                                            <?php the_field('how_we_work_field', $post->ID); ?>
                                        </li>
                                        <li>
                                          <?php the_field('our_beliefs_field', $post->ID); ?>
                                      </li>
...
<!--                           <div class="reputation-icon-wrapper">
            ...
            <div class="about-row05" id="about-project">
              <div class="container-fluid">
                <div class="row">
                  <div class="container">
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="team-header text-center">
                          <h3><?php echo get_the_title( 125 ); ?></h3>
                          <div class="divider divider-default"></div>
                        </div>
                      </div>
                    </div>
